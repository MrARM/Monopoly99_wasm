...
#define WEB_DISPLAY_LOG(message) ((void)0)
...
BOOL __cdecl DISPLAY_initialize( void )
{
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: begin.");
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: configuring UI font.");
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: UI font configured.");

  // FIXME - why waste memory, remove before release
  WEB_DISPLAY_LOG("DISPLAY_initialize: creating message box object.");
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: message box object ready.");
  ...
  // Start up the mouse
  WEB_DISPLAY_LOG("DISPLAY_initialize: starting mouse sequence.");
  LE_SEQNCR_AddMouseSubSequenceTheWorks( LED_IFT( DAT_MAIN, TAB_pointer ), 100, 0, 0, TRUE);
  WEB_DISPLAY_LOG("DISPLAY_initialize: mouse sequence queued.");
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing auction display.");
  DISPLAY_UDAUCT_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing board display.");
  DISPLAY_UDBOARD_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing info bar display.");
  DISPLAY_UDIBAR_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing options display.");
  DISPLAY_UDOPTS_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing pieces display.");
  DISPLAY_UDPIECES_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing player-select display.");
  DISPLAY_UDPSEL_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing sound display.");
  DISPLAY_UDSOUND_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing stats display.");
  DISPLAY_UDSTATS_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: initializing trade display.");
  DISPLAY_UDTRADE_Initialize();
  WEB_DISPLAY_LOG("DISPLAY_initialize: display submodules initialized.");

  FORCE_HMD_USEDEFAULTSHADING(TRUE);

  // Get the rendering/display settings
  WEB_DISPLAY_LOG("DISPLAY_initialize: reading display settings.");
  if (!UDUTILS_ReadINIDisplaySettings())
  {
    WEB_DISPLAY_LOG("DISPLAY_initialize: display settings missing; running fallback setup.");
    // Run the speed test
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: display settings ready.");
  ...
  {
    WEB_DISPLAY_LOG("DISPLAY_initialize: configuring 3D background surface.");
#if USA_VERSION
    ...
    WEB_DISPLAY_LOG("DISPLAY_initialize: 3D background surface configured.");
  }
  else
  {
    // No 3D board
  ...
  WEB_DISPLAY_LOG("DISPLAY_initialize: pause callback set.");

  WEB_DISPLAY_LOG("DISPLAY_initialize: issuing initial DISPLAY_showAll.");
  DISPLAY_showAll;
  WEB_DISPLAY_LOG("DISPLAY_initialize: initial DISPLAY_showAll complete.");

  WEB_DISPLAY_LOG("DISPLAY_initialize: complete.");
  return(TRUE);
}
