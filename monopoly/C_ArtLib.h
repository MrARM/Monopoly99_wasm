...
#define CE_ARTLIB_DO_NOT_OVERRIDE_NEW_AND_DELETE  (MONOPOLY_WEB || !CE_ARTLIB_EnableSystemGrafix3D)
...
#define CE_ARTLIB_EnableSystemBinkStandAlone      (!MONOPOLY_WEB) /* Enables the stand-alone Bink player LE_SEQNCR_TakeOverAndPlayBinkVideo */
...
#define CE_ARTLIB_EnableSystemMMX                 (!MONOPOLY_WEB)
...
#define CE_ARTLIB_EnableSystemSound               (!MONOPOLY_WEB)
...
#define CE_ARTLIB_EnableSystemVideo               (!MONOPOLY_WEB)
...
#define CE_ARTLIB_SoundEnableVoiceChat            (!MONOPOLY_WEB)
