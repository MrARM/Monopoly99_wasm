...
#define WEB_TRADE_LOG(message) monopoly_web_log(message)
#else
#define WEB_TRADE_LOG(message) ((void)0)
#endif
...
void DISPLAY_UDTRADE_Initialize(void)
{
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: begin.");
...
//  }
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: creating left panel.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: left panel ready.");

  int i, j = 14, numlines, height;
  wchar_t WrappedLines[60][512];
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: setting title font.");
  LE_FONTS_SetSettings(0);
  LE_FONTS_SetSize(12);
  LE_FONTS_SetWeight(700);
  LE_FONTS_SetUnderline(TRUE);
  LE_FONTS_SetSettings(7);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: title font set.");

  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: wrapping title.");
  numlines = CHAT_WordWrap(LANG_GetTextMessage(TMN_TRADING), 176, (wchar_t **)WrappedLines, 7);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: title wrapped.");
  height = LE_FONTS_GetStringHeight(CHAT_WrappedLines[0]);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: title height measured.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: title printed.");
  j += 3;

  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: setting body font.");
  LE_FONTS_SetSize(9);
  LE_FONTS_SetWeight(700);
  LE_FONTS_SetUnderline(FALSE);
  LE_FONTS_SetSettings(7);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: body font set.");

  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: wrapping body text.");
  numlines = CHAT_WordWrap(LANG_GetTextMessage(TMN_TRADING2), 176, (wchar_t **)WrappedLines, 7);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: body text wrapped.");
  height = LE_FONTS_GetStringHeight(CHAT_WrappedLines[0]);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: body height measured.");
  for (i = 0; i < numlines; i++, j += height)
    LE_FONTS_Print(leftpanel, (200 - LE_FONTS_GetStringWidth(CHAT_WrappedLines[i])) / 2, j,
      LEG_MCR(220, 220, 220), CHAT_WrappedLines[i]);
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: body text printed.");

  LE_FONTS_GetSettings(0);

  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: creating right/name panels.");
...
//  LE_GRAFIX_ColorArea(NameB, 0, 0, 135, 35, LEG_MCR(0,255,0));
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: right/name panels ready.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: creating cash boxes.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: cash boxes ready.");
  ...
  // Futures/Immunities
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: clearing future/immunity state.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: future/immunity state cleared.");
  ...
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: initializing property structs.");
  UDTrade_InitPropertyStruct(); // initialize the property structures for the trade screen
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: property structs initialized.");
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: initializing player select.");
  UDTrade_InitPlayerSelect();   // initialize the player selection dialog box
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: player select initialized.");
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: initializing cash trade.");
  UDTrade_InitCashTrade();      // initialize the cash trade dialog box
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: cash trade initialized.");
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: initializing future trade.");
  UDTrade_InitFutureTrade();    // initialize the future trade dialog box
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: future trade initialized.");
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: initializing immunity trade.");
  UDTrade_InitImmunityTrade();  // initialize the immunity trade dialog box
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: immunity trade initialized.");
  WEB_TRADE_LOG("DISPLAY_UDTRADE_Initialize: complete.");
}
